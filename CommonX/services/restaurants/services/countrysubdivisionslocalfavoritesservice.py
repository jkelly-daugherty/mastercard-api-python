...
from services.restaurants.domain.country_subdivisions import countrysubdivision
from services.restaurants.domain.country_subdivisions import countrysubdivisions
...
class CountrySubdivisionsLocalFavoritesService(connector.Connector):
